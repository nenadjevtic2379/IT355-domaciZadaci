    ...
    <body>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                                ...
                                <c:if test="${pageContext.request.isUserInRole('admin') && !pageContext.request.isUserInRole('user')}">
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/allnarudzbine"/>">Narudžbine</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Pregled narudžbina</h1>
		...
		function formSubmit() {
            ...
            <h2>Pregled svih narudžbina:</h2>
                ...
                <table class="table table-condensed">
                    ...
                    <c:forEach items="${narudzbine}" var="nar">
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <td>${nar.status}</td>
                                    <td>${nar.username}</td>
                                    <td>${nar.id_proizvod.tip.naziv}</td>
                                    <td>${nar.id_proizvod.cena}</td> 
                                    <td>${nar.id_proizvod.vrsta}</td> 
                                    <td>${nar.id_proizvod.zaauto}</td> 
                                    <td>${nar.id_proizvod.proizvodnja}</td> 
                                   
                                    
                                 
                                
                                        <td><a href="<c:url value='/obrisiIzKorpe/${nar.id_korpa}' />"><span class="glyphicon glyphicon-remove"></span></a></td>
                                        <td><a href="<c:url value='/editKorpa/${nar.id_korpa}' />"><span class="glyphicon glyphicon-edit"></span></a></td>
                                        <td>
                                </td>
                            </tr>
