    ...
    <body>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/addtip"/>">Dodaj tip</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Dodaj tip proizvoda</h1>
...
<c:url value="/j_spring_security_logout" var="logoutUrl" />
 ...
 <!--refresh jsp-a nakon post -->  <form:form onsubmit="setTimeout(function () { window.location.reload(); }, 30)" method="POST" modelAttribute="tipProizvoda">
                        ...
                        <div class="field-wrap">
                            <label>
                                Tip proizvoda:<span class="req">*</span>
                            </label>
                            <form:input id="naziv" path="naziv" type="text" autocomplete="off"/>
                        </div>
