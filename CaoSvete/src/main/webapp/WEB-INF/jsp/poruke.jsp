...
<html lang="en" class="no-js">
    ...
    <body>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/poruke"/>">Poruke</a></li>
                                </c:if>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Poruke</h1>
	...
	<script>
		function formSubmit() {
            ...
            <h2>Informacije o korisnicima:</h2>
             <c:if test="${!empty porukeLista}">
            <table class="table table-condensed">
                ...
                <c:forEach items="${porukeLista}" var="poruke">
                <tbody>
                    <tr>
		
                        <td>${poruke.ime}</td>
			<td>${poruke.email}</td>
                        <td>${poruke.telefon}</td>
                        <td>${poruke.poruka}</td>
