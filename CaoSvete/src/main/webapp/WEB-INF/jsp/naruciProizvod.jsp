    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="./mojakorpa">Moja korpa</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Potvrda dodavanja u korpu</h1>
                <p>Strana za kupce</p>
            </div>
        </div>
        ...
        <div class="form">
            ...
            <div class="tab-content">
                <div id="signup">   
                    <h3>Da li ste sigurni da želite da naručite izabrani izabrani proizvod?</h3>


                    

                    
                      <form:form  method="POST"  modelAttribute="korpa">
                        
                        
                            
                       

                            <form:input type="hidden" id="id_proizvod" class="form-control"  path="id_proizvod" />
                        ...
                        <button onsubmit="setTimeout(function () { window.location.reload(); }, 10)" type="submit"  class="button button-block"/>Dodaj</button>
