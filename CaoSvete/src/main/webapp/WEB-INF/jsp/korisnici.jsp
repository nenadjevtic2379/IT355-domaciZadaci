    ...
    <body>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/info"/>">Korisnici</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Informacije o korisnicima</h1>
	...
	<script>
		function formSubmit() {
            ...
            <table class="table table-condensed">
                ...
                <c:forEach items="${usersLista}" var="user">
                <tbody>
                    <tr>
