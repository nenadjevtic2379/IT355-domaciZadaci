    ...
    <body>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                                ...
                                <c:if test="${pageContext.request.isUserInRole('admin') && !pageContext.request.isUserInRole('user')}">
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/sviTipoviHib"/>">Tipovi</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="<c:url value="/resources/img/1920x1080/01.jpg" /> ">
            <div class="parallax-content container">
                <h1 class="carousel-title">Tipovi proizvoda</h1>
		...
		function formSubmit() {
            ...
            <c:if test="${!empty tipoviLista}">
                <table class="table table-condensed">
                    ...
                    <c:forEach items="${tipoviLista}" var="tip">
                        <tbody>
                            <tr>

                                <td>${tip.id}</td> 
                                <td>${tip.naziv}</td>
                                <td><a href="<c:url value='/obrisitip/${tip.id}' />"><span class="glyphicon glyphicon-remove"></span></a></td>
                                <td>
                                </td>
                            </tr>
