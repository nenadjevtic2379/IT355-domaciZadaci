            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <li class="nav-item"><a class="nav-item-child nav-item"><span class="glyphicon glyphicon-user ">${pageContext.request.userPrincipal.name}</span></a></li>			 
                               ...
                               <c:if test="${!pageContext.request.isUserInRole('user') && !pageContext.request.isUserInRole('admin')}">
                             <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="<c:url value="/reg"/>"><span class="glyphicon glyphicon-user"></span></a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover " href="<c:url value="/login"/>"><span class="glyphicon glyphicon-log-in"></span></a></li>
                                </c:if>
