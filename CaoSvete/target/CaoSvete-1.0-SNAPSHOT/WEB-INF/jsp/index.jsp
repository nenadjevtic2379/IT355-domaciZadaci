    ...
    <body>
        ...
        <div class="content-lg container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<c:url value="/resources/img/970x647/01.jpg"/>" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<c:url value="/resources/img/970x647/02.jpg"/>" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<c:url value="/resources/img/970x647/03.jpg"/>" alt="Latest Products Image">
                        </div>
                    </div>
        ...
        <div class="promo-section overflow-h">
            ...
            <div class="promo-section-img-right">
                <img class="img-responsive" src="<c:url value="/resources/img/970x970/01.jpg"/>" alt="Content Image">
            </div>
        </div>
        <!-- End Promo Section -->
                ...
                <div class="masonry-grid">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="<c:url value="/resources/img/800x400/01.jpg"/>" alt="Portfolio Image">
                            </div>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="<c:url value="/resources/img/397x400/01.jpg"/>" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="<c:url value="/resources/img/397x300/01.jpg"/>" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="<c:url value="/resources/img/397x300/02.jpg" />"alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".5s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="<c:url value="/resources/img/397x300/03.jpg"/>" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
                                <h3 class="color-white margin-b-5">Clean Design</h3>
                                <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
